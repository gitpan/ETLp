...
The Runtime Audit Browser provides a web-based interface to the ETL job runs. Sceenshots to accompany this documnetation can be viewed at L<http://firefly.activestate.com/dhorne/etlp/wiki/UsingTheAuditBrowser>
